...
#define PRGNAME     "GSIPLOT"           // program name
...
#define TRACEFILE   "gsiplot.trace"     // trace file
#define QCTMPFILE   "gsiplot_qc.temp"   // tempolary file for qc
#define QCERRFILE   "gsiplot_qc.err"    // error file for qc
...
private:
    ...
    void __fastcall DrawTrkStat  (const TIMEPOS *pos, AnsiString header, int p, int num);
    ...
    void __fastcall DrawSolStat  (const TIMEPOS *pos, AnsiString unit, int p, int num);
